struct defaults{
    ...
    static void usage(){
        ...
        puts("--pattern   <string> <number>   prints string the given ammount of times\n");
        puts("Binary options:");
        puts("--magic     <file>              prints magic bytes from ELF files\n");
        puts("Process options:");
        puts("--stack     <string>            give process pid to dump its stack");
        puts("--status    <string>            give process pid to dump its status");
        puts("--io        <string>            give process pid to dump its IO data");
        puts("--maps      <string>            give process pid to dump its mappings");
        puts("--limits    <string>            give process pid to dump its limits");
        puts("--clone     <string>            give process pid to dump its binary\n");
        puts("System options:");
        ...
        puts("--sub       <string> <number>   subtracts value of string from a value");
        puts("--mult      <string>            multiplies value of string together");
        puts("--shift     <string> <number>   bit shifts a string by a value");
        puts("--xor       <string> <number>   xores a string by a value");
        puts("--xors      <string>            xores a string by all 256 values\n");
        ...
        puts("--back                          continue execution in background");
